...
class IpAddressValidator implements ConstraintValidator<IpAddress, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        Pattern patternIPv4 = Pattern.compile("^(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$");
        ...
        try {
            return patternIPv4.matcher(value).find() || patternIPv6.matcher(value).find();
        } catch (Exception e) {
            return false;
        }
    }
